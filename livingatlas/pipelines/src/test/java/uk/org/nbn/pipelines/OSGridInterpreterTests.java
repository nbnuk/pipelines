...
public class OSGridInterpreterTests extends OSGridTestBase {
    ...
    public void applyIssue_issuesTermAddedToOSGridRecord() {
        ...
        final List<String> expectedIssues = Arrays.asList(NBNOccurrenceIssue.GRID_REF_CALCULATED_FROM_LAT_LONG.name(), NBNOccurrenceIssue.COORDINATES_NOT_CENTRE_OF_GRID.name());
        ...
        OSGridRecord osgr = OSGridRecord.newBuilder()
                .setId(ID)
                .build();
    ...
    public void addGrid_useProcessedGridReferenceWhenSet() {
        ...
        OSGridRecord osgr = OSGridRecord.newBuilder()
                .setId(ID)
                .setGridReference(expectedGridReference)
                .build();
    ...
    public void validateSuppliedGridReferenceAndLatLon_issueAddedForNonCentroidLatLon() {
        ...
        Assert.assertTrue(osgr.getIssues().getIssueList().contains(NBNOccurrenceIssue.COORDINATES_NOT_CENTRE_OF_GRID.name()));
    }

    private ExtendedRecord getRecordWithAllLocationTerms(String gridReference,
                                                         Integer gridSize,
        ...
        coreMap.put(DwcTerm.coordinateUncertaintyInMeters.qualifiedName(), String.valueOf(coordinateUncertainty));
    ...
    public void setGridRefFromCoordinates_gridReferenceSetFromLatLon() {
        ...
        ExtendedRecord er = getRecordWithAllLocationTerms(gridReference, gridSize, coordinateUncertainty, centroidLatitude, centroidLongitude);
    ...
    @Test
    public void setGridRefFromCoordinates_gridReferenceSetFromLatLonUsingCoordinateUncertaintyIfNoGridSize() {
        String gridReference = "NM39";
        Integer gridSize = 10000;
        double coordinateUncertainty = 7071.1;
        double centroidLatitude = 56.970009;
    ...
    public void setGridRefFromCoordinates_issueAddedIfRecordNotSuppliedWithGridReference() {
        ...
        ExtendedRecord er = getRecordWithAllLocationTerms(suppliedGridReference, gridSize, coordinateUncertainty, centroidLatitude, centroidLongitude);
        ...
        Assert.assertTrue(osgr.getIssues().getIssueList().contains(NBNOccurrenceIssue.GRID_REF_CALCULATED_FROM_LAT_LONG.name()));
    }
    ...
    public void processGridWKT_notSetIfNotSuppliedWithGridReference() {
        ...
        OSGridRecord osgr = OSGridRecord.newBuilder()
                .setId(ID)
                .setGridReference(computedGridReference)
                .build();
    ...
    public void processGridWKT_setFromComputedGridReferenceWhenSuppliedWithGridReference() {
        ...
        final String expectedGridReferenceWKT = "POLYGON((-4.60801 54.20547,-4.60801 54.22409,-4.5785 54.22409,-4.5785 54.20547,-4.60801 54.20547))";
