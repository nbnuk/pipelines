...
public class GridUtilTests {
    ...
    public void convertOSGridReferenceToEastingAndNorthing(String gridRefernce, String gridLetters, int easting, int northing, Integer gridSize, int minEasting, int minNorthing, int maxEasting, int maxNorthing, String datum) {

        GridRef result = GridUtil.gridReferenceToEastingNorthing(gridRefernce).getOrElse(null);
        GridRef expected = new GridRef(gridLetters, easting, northing, Option.apply(gridSize), minEasting, minNorthing, maxEasting, maxNorthing, datum);
    ...
    public void convertIrishGridReferenceToEastingAndNorthing(String gridRefernce, String minLatitude, String minLongitude) {
    ...
    @ParameterizedTest
    @CsvSource({
            "H99, 290000, 390000,  54.793876, -6.523798"
    })
    public void convertIrishGridReferenceToEastingAndNorthing2(String gridRefernce, String easting, String northing, String latitude, String longitude) {
    ...
    @ParameterizedTest
    @CsvSource({
            "NM39, 56.970009, -6.361995, EPSG:4326, 7071.1"
    })
    public void convertOSGridTOLatLonWGS84(String gridReference, String latitude, String longitude, String datum, String uncertainty) {
    ...
    public void checkGridRefenceAtDifferentResolutions(String gridReference, String grid_ref_100000, String grid_ref_10000, String grid_ref_2000, String grid_ref_1000, String grid_ref_100) {
    ...
    public void twoKmGridReferencesAtDifferentResolutions(String gridReference, String grid_ref_100000, String grid_ref_10000, String grid_ref_2000) {

        GridRef eastingNorthing = GridUtil.gridReferenceToEastingNorthing(gridReference).getOrElse(null);
        Assert.assertNotNull(eastingNorthing);

        String newGridRef =  eastingNorthing.gridLetters() + String.valueOf(eastingNorthing.easting()).substring(1) + String.valueOf(eastingNorthing.northing()).substring(1);
    ...
    public void latLonToOSGridAtDifferentResolutions(String expectedGridReference, Double latitude, Double longitude, Double gridSize, String datum, String gridType) {

        String result = GridUtil.latLonToOsGrid(latitude, longitude, gridSize, datum, gridType, -1).getOrElse(null);
    ...
    public void gridCentroid(boolean expectedResult, double longitude, double latitude, String gridReference) {
    ...
    public void _1mGridRoundingErrorTest() {
        ...
        String result = GridUtil.getOSGridFromNorthingEasting(grid.northing(), grid.easting(), 10, "OSGB").get();
    ...
    public void gridReferenceDigitsForCoordinateUncertainty(Integer expectedDigits, Double uncertainty) {
